...
canvas = tk.Canvas(root, height = HEIGHT, width = WIDTH)  # ------------------- Creating Canvas ---------------->
cv_img = cv2.cvtColor(cv2.imread("welcome.png"), cv2.COLOR_RGB2BGR) # --------------- variable to read Image ----------->
photo = PIL.ImageTk.PhotoImage(image=PIL.Image.fromarray(cv_img)) # ------------ Way to Insert photo into canvas -------------->
image_on_canvas = canvas.create_image(0, 0, ancho=tkinter.NW, image=photo)
canvas.pack()  # ---------------- Closing Canvas ---------------->
